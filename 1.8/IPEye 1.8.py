...
title_label = tk.Label(root, text="> Saysaa - v1.8 <", font=(font_style, 9, 'bold'), bg="black", fg="orange")
title_label.pack(side=tk.TOP, pady=10)
...
title_label = tk.Label(root, text="t.me/ipeyedownload", font=(font_style, 9, 'bold'), bg="black", fg="orange")
title_label.pack(side=tk.TOP, pady=10)

title_label = tk.Label(root, text="Il se peut que certaines infos soit erronés.", font=(font_style, 7, 'bold'), bg="black", fg="red")
