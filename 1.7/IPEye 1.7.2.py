...
def locate_ip():
    ip = ip_entry.get()
    loading_label.config(text="Récupération des informations de l'IP...")
...
title_label = tk.Label(root, text="Saysaa - v1.7.2", font=(font_style, 9, 'bold'), bg="black", fg="orange")
title_label.pack(side=tk.TOP, pady=10)

# Label de chargement
loading_label = tk.Label(root, text="", font=('Helvetica', 12), bg="black", fg="white")
