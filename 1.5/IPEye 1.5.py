...
# Texte "IPEye"
title_label = tk.Label(root, text="IPEye 1.5", font=(font_style, 16, 'bold'), bg="black", fg="purple")
title_label.pack(side=tk.TOP, pady=10)
title_label = tk.Label(root, text="Fonctionne uniquement avec les IP Publiques.", font=(font_style, 9, 'bold'), bg="black", fg="red")
title_label.pack(side=tk.TOP, pady=10)
